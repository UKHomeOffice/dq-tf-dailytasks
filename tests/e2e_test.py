...
class TestE2E(unittest.TestCase):
    ...
    def test_iam_lambda_ec2_shutdown_role_tags(self):
        self.assertEqual(self.result['root_modules']["aws_iam_role.ec2_shutdown_testrole"]["tags.Name"], "ec2_shutdown_testrole")
    ...
    def test_iam_policy_document_ec2_tags(self):
        self.assertEqual(self.result['root_modules']["aws_iam_policy_document.eventwatch_ec2_doc"]["tags.Name"], "eventwatch_ec2_doc")
    ...
    def test_iam_policy_ec2_tags(self):
        self.assertEqual(self.result['root_modules']["aws_iam_policy.eventwatch_ec2_policy"]["tags.Name"], "eventwatch_ec2_policy")
    ...
    def test_iam_role_policy_attachment_ec2_tags(self):
        self.assertEqual(self.result['root_modules']["aws_iam_role_policy_attachment.eventwatch_ec2_policy_attachment"]["tags.Name"], "eventwatch_ec2_policy_attachment")
    ...
    def test_cloudwatch_ec2shut_event_rule(self):
        self.assertEqual(self.result['root_modules']["aws_cloudwatch_event_rule.daily_ec2_shutdown"]["tags.Name"], "daily_ec2_shutdown")
