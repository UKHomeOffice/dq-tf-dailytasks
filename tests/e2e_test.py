...
class TestE2E(unittest.TestCase):
    ...
    def test_name_suffix_aws_lambda_function_cleanup_snapshots_tags(self):
          self.assertEqual(self.result['aws_maintenance']["aws_lambda_function.cleanup_snapshots_function"]["tags.Name"], "cleanup_snapshots-notprod-dq")

    def test_name_suffix_aws_iam_role_cleanup_snapshots_role_tags(self):
          self.assertEqual(self.result['aws_maintenance']["aws_iam_role.cleanup_snapshots_role"]["tags.Name"], "cleanup_snapshots_role-notprod-dq")
